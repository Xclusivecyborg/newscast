...
import 'package:newscast/view/news_viewstate.dart';
import 'stack_small_card.dart';

final _viewModelProvider = StateNotifierProvider<NewsViewModel, NewsViewState>(
    (val) => NewsViewModel());
...
class NewsBody extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final model = ref.read(_viewModelProvider.notifier);
    return Column(
